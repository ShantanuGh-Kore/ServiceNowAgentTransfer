...
client.messages.create({
    body: 'CovidHelper: I found a emergency at '+canton+','+age+','+sex+'. Please help him immediately.',
...
module.exports = {
    ...
    on_agent_transfer: function(requestId, data, callback) {
        ...
        sendSmsNotification(data.context.entities.Canton,context.entities.Age,context.entities.Geneder);
        debug('on_webhook');
